...
SEEDS = {
    ...
    'svm': get_seed([0, 0, 0, 0, 0], NUM_DATASETS_TO_LOAD),
    'rf': get_seed([0, 0, 0, 0, 0], NUM_DATASETS_TO_LOAD),
    'knn': get_seed([0, 0, 0, 0, 0], NUM_DATASETS_TO_LOAD)
}
...
def main():
    ...
    # models_and_seeds = [(cnn, SEEDS['cnn']), (svm, SEEDS['svm']), (rf, SEEDS['rf']),
    #                     (knn, SEEDS['knn'])]
